...
import coreValue1 from "../assets/core-value-1.jpg";
import coreValue2 from "../assets/core-value-2.jpg";
    ...
    <section id="about" className="about">
      <div className="about-section section-left">
        <div className="about-text">
          ...
          <p>
            Công ty TNHH Năm Con Khỉ (MONKEY5) được thành lập vào ngày 14 tháng 01 năm 2025
            bởi CEO – Founder Lee Duck Loong (Lê Đức Long).
          </p>
          <p>
      ...
      <div className="about-section section-right">
        <div className="about-text">
          ...
          <p>
            Tên gọi MONKEY5 lấy cảm hứng từ hình ảnh những chú khỉ tinh trên hành trình
            chăm chỉ hái chuối kiếm ăn để nói về các chị cộng tác viên giúp việc luôn hoàn thành
            ...
            tiện lợi và nhanh chóng. MONKEY5 còn ám chỉ đến 5 người đứng đầu công ty
            (Hoàng Anh - Đức Long - Ngọc Thạch - Hoàng Phúc - Sỹ Siêu) được dẫn đầu bởi
            Hầu vương Lee Duck Loong sẵn sàng khẳng định tên tuổi của mình trong mảng
            dịch vụ Home Service.
          </p>
        </div>
        <div className="about-image">
      ...
      <div className="about-section section-right">
        <div className="about-text">
          ...
          <p>
            Tại Việt Nam, tính đến nay, MONKEY5 đã giúp hơn 1,000,000,000 người giúp việc
            có thu nhập ổn định và đáp ứng nhu cầu chăm sóc nhà cửa cho hơn 10,000,000,000
      ...
      <div className="core-values">
        ...
        <div className="core-values-images">
          <img src={coreValue1} alt="Core Value 1" />
          <img src={coreValue2} alt="Core Value 2" />
        </div>
